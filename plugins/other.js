...
async (conn, mek, m, {
    ...
    try {
        ...
        const response = await axios.get("https://freezetech.site/Main/main_var.json");
        const details = response.data;

        const result = `*🧿PHONIX MD🧿*
...
cmd({
  ...
  try {
    ...
    const text = `🌍 *Phonix Country Information: ${info.name}* 🌍\n\n` +
